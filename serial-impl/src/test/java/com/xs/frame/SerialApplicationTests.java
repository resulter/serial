...
public class SerialApplicationTests {
	...
	public void getProfessionSerialNumber_test1 () {
		...
		for(int i = 0;i<2;i++) {
			Long result = redisSequence.getMaxValue("01002_181206");
			...
			result = redisSequence.getMaxValue("01002_181205");
			System.out.println(i+1 + "  ***   new_redis_value:" + result);
		}
	}
	...
	public void getProfessionSerialNumber_test1_1000 () throws Exception {
		...
		for(int i=0;i<180;i++){
			Long result = redisSequence.getMaxValue("01001_181206");
			System.out.println("old_redis_value:"+result);
			BusinessSerial businessSerial = new BusinessSerial();
			businessSerial.setBusinessNo("1001");
			businessSerial.setPlatform("1");
			...
			result = redisSequence.getMaxValue("01001_181206");
	...
	public void getSerial(){
        ...
        System.out.println("**result : "+publicResult.getResult());
	}
